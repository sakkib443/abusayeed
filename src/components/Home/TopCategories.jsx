                            ...
                            <Link href={category.href}>
                                <div className={`bg-white dark:bg-gray-900 rounded-xl p-4 border-l-4 ${category.borderColor} shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col cursor-pointer group`}>
                                    ...
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        {/* Arrow */}
                                        <div className="text-gray-300 dark:text-gray-600 group-hover:text-[#003ECB] transition-colors">
                                    ...
                                    <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-100 dark:border-gray-800">
                                        ...
                                        <span
                                            className={`text-sm font-medium text-[#003ECB] group-hover:text-[#002da3] transition-colors ${bengaliClass}`}
                                        >
